...
const std::string version_info{"1.7.20.3.20-beta"};
...
const std::vector<std::string> settings_data{"Text animation speed", "Linear search type", "welcome messages", "hints", "Reset"};
...
const std::vector<std::string> help_char_data{"Esc", "a", /* "c",*/ "d", "h", /* "i",*/ "l", "q", "s", "t", "u"};
const std::vector<std::string> help_desc_data{"Return to last screen", "About the software", /* "Show code",*/ "Change hint settings", "Help", /* "Analyse the code",*/ "Changelog", "Quit", "Open settings", "Linear search type", "Get Updates"};
