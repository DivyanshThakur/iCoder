...
const std::vector<std::string> helpCharData{"Esc", "a", /* "c",*/ "d", "h", /* "i",*/ "l", "q", "s", "u"};
const std::vector<std::string> helpCharDesc{"Return to last screen", "About the software", /* "Show code",*/ "Change hint settings", "Help", /* "Analyse the code",*/ "Changelog", "Quit", "Open settings", "Get Updates"};
