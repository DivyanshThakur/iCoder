...
const std::vector<std::string> settingsMenu{"Text animation speed", "Linear search type", "Shortcut access", "Themes", "Display style", "whitespaces for string", "welcome messages", "quit confirmation", "hints", "Reset"};
