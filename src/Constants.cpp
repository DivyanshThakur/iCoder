...
const std::vector<std::string> settingsMenu{"Text animation speed", "Linear search type", "welcome messages", "hints", "Reset"};
...
const std::vector<std::string> helpCharData{"Esc", "a", /* "c",*/ "d", "h", /* "i",*/ "l", "q", "s", "t", "u"};
const std::vector<std::string> helpCharDesc{"Return to last screen", "About the software", /* "Show code",*/ "Change hint settings", "Help", /* "Analyse the code",*/ "Changelog", "Quit", "Open settings", "Linear search type", "Get Updates"};
