...
const std::vector<std::string> SmallMenu::average{"Average of all elements", "Select a range"};
const std::vector<std::string> SmallMenu::sum{"Sum of all elements", "Select a range"};
